...
// ✅ Initialize Gemini once globally using latest stable model
const genAI = new GoogleGenerativeAI(process.env.GEMINI_API_KEY);

// Convert Decimal to JS Number safely
...
export async function createTransaction(data) {
  try {
    ...
    // Create transaction + update account atomically
...
// ✅ Scan Receipt using Gemini 2.5 Flash
